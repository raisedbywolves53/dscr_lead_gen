# Module 6: ICP Scoring, Tagging, and Excel Output

## Purpose
Take enriched leads from Module 5, classify each into an ICP segment, score by lead quality, and produce the final Excel spreadsheet with multiple tabs.

## Script: `scripts/06_score_and_output.py`
...
Multi-tab Excel workbook with:
- **All Leads** — master list sorted by score
- **Per-ICP tabs** — filtered by segment
